...
The diagrams carry the weight. Prose is sparse, plain, and uses the architecture language from the principles (module, interface, depth, deep, shallow, boundary, adapter, leverage, locality) without ceremony.
...
Plain English, concise, but the architectural nouns and verbs come straight from the principles. Concision is not an excuse to drift.
...
No hedging, no throat-clearing, no "it's worth noting that…". If a sentence could be a bullet, make it a bullet. If a bullet could be cut, cut it. If a term isn't in the architecture language above, reach for one that is before inventing a new one.
